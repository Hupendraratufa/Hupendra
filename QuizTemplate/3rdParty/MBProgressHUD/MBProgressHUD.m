...
//    else
//        [(FFCircularProgressView*)indicator setProgress:progress];
...
//        else
//        {
//            self.indicator = [[[FFCircularProgressView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 37.0f, 37.0f)] autorelease];
            self.indicator.tintColor = self.progressImageColor;
//        }
    }
